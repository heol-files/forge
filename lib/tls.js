...
tls.createClientHello = function(c) {
  ...
  for(var i = 0; i < c.cipherSuites.length; ++i) {
    ...
    // Simulate Full Cipher Support for ECDHE and ECDSA ciphers
    // IIS Workaround
    if(cs.name === 'TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA') {
      // Cipher Suite: TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 (0xc02b)
      // cipherSuites.putByte(0xc0);
      // cipherSuites.putByte(0x2b);
      // Cipher Suite: TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 (0xc02f)
      // cipherSuites.putByte(0xc0);
      // cipherSuites.putByte(0x2f);
      // Cipher Suite: TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA (0xc00a)
      cipherSuites.putByte(0xc0);
      cipherSuites.putByte(0x0a);
      // Cipher Suite: TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA (0xc009)
      // cipherSuites.putByte(0xc0);
      // cipherSuites.putByte(0x09);
      // Cipher Suite: TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA (0xc013)
      // cipherSuites.putByte(0xc0);
      // cipherSuites.putByte(0x13);
      // Cipher Suite: TLS_DHE_RSA_WITH_AES_128_CBC_SHA (0x0033)
      // cipherSuites.putByte(0x00);
      // cipherSuites.putByte(0x33);
      // Cipher Suite: TLS_DHE_RSA_WITH_AES_256_CBC_SHA (0x0039)
      cipherSuites.putByte(0x00);
      cipherSuites.putByte(0x39);
    }
  }
  ...
  */
  ...
  // Append Custom Extensions To Handshake
  if(c.customExtensions) {
    for(var i=0;i<c.customExtensions.length;i++) {
      extensions.putBytes(c.customExtensions[i])
    }
  }
  ...
  var algorithms = {};
  for(var i=0;i<c.cipherSuites.length;i++) {
    switch(c.cipherSuites[i].name) {
      case 'TLS_RSA_WITH_AES_128_CBC_SHA':
      case 'TLS_RSA_WITH_AES_256_CBC_SHA':
        algorithms['SHA1-RSA'] = [0x02, 0x01];
        break
      case 'TLS_RSA_WITH_AES_128_CBC_SHA256':
      case 'TLS_RSA_WITH_AES_256_CBC_SHA256':
        algorithms['SHA256-RSA'] = [0x04, 0x01];
        break
      case 'TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA':
        algorithms['SHA256-EDCSA'] = [0x04, 0x03];
        algorithms['SHA512-RSA'] = [0x06, 0x01]
        // algorithms['SHA512-DSA'] = [0x06, 0x02]
        algorithms['SHA512-ECDSA'] = [0x06, 0x03]
        algorithms['SHA384-RSA'] = [0x05, 0x01]
        // algorithms['SHA384-DSA'] = [0x05, 0x02]
        algorithms['SHA384-ECDSA'] = [0x05, 0x03]
        algorithms['SHA384-ECDSA'] = [0x02, 0x03]
        break
    }
  }
...
tls.createConnection = function(options) {
  ...
  var c = {
    ...
    customExtensions: options.extensions || [],
    entity: entity,
